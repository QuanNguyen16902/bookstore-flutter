...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: TitleTextWidget( label: 'Địa chỉ của tôi',),
        actions: [
          IconButton(
            icon: Icon(Icons.add),
            onPressed: () async {
      ...
      body: userProvider.getUserModel!.addresses.isEmpty
          ? Center(child: TitleTextWidget(label: 'Chưa có address',))
          : ListView.builder(
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text('${address.state}, ${address.country}, ${address.zipCode}'),
                    ),
                  ),
                );
              },
